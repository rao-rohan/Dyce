...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DyceAppIOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10DyceAppIOS11AppDelegate")
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified categoryButton;
...
- (void)uploadPost;
- (IBAction)pressCategoryButton:(id _Nonnull)sender;
...
@interface NewPostViewController (SWIFT_EXTENSION(DyceAppIOS)) <CLLocationManagerDelegate>
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didFailWithError:(NSError * _Nonnull)error;
@end


SWIFT_CLASS("_TtC10DyceAppIOS12QuestionCell")
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified usernameLabel;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified categoryFlag;
...
SWIFT_CLASS("_TtC10DyceAppIOS19ReplyViewController")
